...
@section('title', 'Pinjaman Angunan BPKB')
...
@section('content-header')
  ...
  <div class="content-header-left col-md-6  breadcrumb-new">
    <h3 class="content-header-title mb-0 d-inline-block text-capitalize">Angunan BPKB</h3>
  ...
  <div class="content-header-right col-md-1 breadcrumb-new text-right">
...
<div id="createPeminjaman" class="modal fade">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form action="{{Route ('pages.anggota.peminjaman.AngunanBpkb.store')}}" method="POST">
        ...
        <div class="modal-body">
          <div class="container">
            ...
            <center>
            <p><b>INFORMASI BPKB</b></p>
            </center>
            <div class="form-group">
              <label class="label label-default">Atas Nama</label>
            ...
            <div class="form-group">
              <label class="label label-default">Warna</label>
              <input type="text" class="form-control" name="warna" required>
            </div>

            <div class="form-group">
              <label class="label label-default">Nomor Polisi</label>
              <input type="text" class="form-control" name="no_polisi" required>
            </div>

            <div class="form-group">
              <label class="label label-default">Nomor Rangka</label>
              <input type="text" class="form-control" name="no_rangka" required>
            </div>

            <div class="form-group">
              <label class="label label-default">Nomor Mesin</label>
