          ...
          <table class="table table-hover w-100 table-responsive" id="PendanaansTable">
            <thead>
              <tr>
                ...
                <th><i class="fa fa-id-badge"></i> Nomor Anggota</th>
                ...
                <th><i class="fa fa-clipboard-check"></i> Status HR</th>
                <th><i class="fa fa-file-signature"></i> Bukti HR</th>
            ...
            <tbody>
              @foreach ($Pendanaans as $item)
                  <tr>
                    ...
                    <td>
                      <button class=" btn btn-outline-info btn-block tombolLihatBuktiHR" value="{{ $item->bukti_hr }}">
                    ...
                    <td>
                      <div class="action-button btn-group text-center">
                        ...
                        <div class="dropdown-menu" x-placement="bottom-start">
                          ...
                          <button class="dropdown-item tombolkonfirmasihr" value="{{ $item->id }}">
...
<!-- Modals Bukti HR -->
<div class="modal fade" id="lihatBuktiHR">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">

      <div class="modal-header bg-info">
        <h4 class="text-white"><i class="fa fa-file-signature"></i> Bukti Persetujuan HR</h4>
        <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
      </div>

      <div class="modal-body">
        <img src="" id="lihatGambar" class="img-fluid" alt="Gambar Tidak Tersedia">
      </div>
...
{{-- Modal Konfirmasi Ajuan Pendanaan HR --}}

<div class="modal-create modal fade" id="konfirmasihr">
  <div class="modal-dialog modal-lg">
    <div class="modal-create-content modal-content">
      <form action="{{ route('pengurus.marketplace.konfirmasi.hr') }}" method="POST">

        <!-- Modal Header -->
        <div class="modal-create-header modal-header bg-info">
          <h4 class="modal-title text-white"><i class="fa fa-clipboard-check"></i> Konfirmasi Persetujuan HR</h4>
          <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
        </div>
        ...
        <div class="modal-create-body modal-body">
          <div class="container">
            ...
            <select name="status_hr" id="status_hr" class="form-control">
        ...
        <div class="modal-create-footer modal-footer">
          <button type="submit" class="btn btn-info btn-glow">Konfirmasi <i class="fa fa-check"></i> </button>
        </div>
...
@section('script')
  ...
  <script type="text/javascript">
    ...
    $(".tombolLihatBuktiHR").on("click", function(){
      var bukti_hr = $(this).val();
      $("#lihatGambar").attr("src", bukti_hr);
      $("#lihatBuktiHR").modal();
    });

    $(".tombolkonfirmasihr").on("click", function(){
      var id = $(this).val();
      $.ajax({
        method: "POST",
        url: "{{ route('pengurus.marketplace.form.konfirmasi.hr') }}",
        data: {
          _token: token,
          id: id,
        }
        ...
        $(".id").val(response.id);
        $("#konfirmasi").val(response.status_hr);
        $("#konfirmasihr").modal();
      });
    });
