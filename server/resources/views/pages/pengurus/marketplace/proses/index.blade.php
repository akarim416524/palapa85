...
@section('content')
  ...
  <div class="card">
    <div class="card-header">
      <h4 class="card-title" id="basic-layout-form">Tabel Proses Pendanaan</h4>
      ...
      <div class="card-body">
        <div class="container">
          <table class="table table-hover w-100 table-responsive" id="Pendanaans2Table">
            ...
            <tbody>
              @foreach ($ProsesPendanaans as $item)
                  <tr>
                    <td>{{ $item->id }}</td>
                    ...
                    <td>
                      <div class="action-button btn-group text-center">
                        ...
                        <div class="dropdown-menu" x-placement="bottom-start">
                          ...
                          <button class="dropdown-item tombolkonfirmasipengurus" value="{{ $item->id }}">
...
{{-- Modal Konfirmasi Ajuan Pendanaan Pengurus --}}

<div class="modal-create modal fade" id="konfirmasipengurus">
  <div class="modal-dialog modal-lg">
    <div class="modal-create-content modal-content">
      <form action="{{ route('pengurus.marketplace.konfirmasi.pengurus') }}" method="POST">

        <!-- Modal Header -->
        <div class="modal-create-header modal-header bg-info">
          <h4 class="modal-title text-white"><i class="fa fa-clipboard-check"></i> Konfirmasi Permintaan</h4>
        ...
        <div class="modal-create-body modal-body">
          <div class="container">
            ...
            <input type="hidden" name="id_pengurus" value="{{ Auth::user()->id }}">

            <label><i class="fa fa-clipboard-check"></i> Konfirmasi</label>
            <select name="status_pengurus" id="status_pengurus" class="form-control">
            ...
            <div class="form-group">
              <label><i class="fa fa-info"></i> Keterangan</label>
                <textarea nname="catatan_pengurus" id="catatan_pengurus" rows="4" cols="86"></textarea>
            </div>
...
@section('script')
  ...
  <script type="text/javascript">
    ...
    $(".tombolkonfirmasipengurus").on("click", function(){
      var id = $(this).val();
      $.ajax({
        method: "POST",
        url: "{{ route('pengurus.marketplace.form.konfirmasi.pengurus') }}",
        data: {
          _token: token,
          id: id,
        }
        ...
        $(".id").val(response.id);
        $("#konfirmasi").val(response.status_pengurus);
        $("#catatan_pengurus").val(response.catatan_pengurus);
        $("#konfirmasipengurus").modal();
      });
    });
