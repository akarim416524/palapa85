...
@section('title', 'Palapa 85 - Anggota')
...
@section('content-header')
  ...
  <div class="content-header-left col-md-6  breadcrumb-new">
    <h3 class="content-header-title mb-0 d-inline-block text-capitalize">Anggota</h3>
  ...
  <div class="content-header-right col-md-6 breadcrumb-new text-right">
    <button type="button" name="button" class="btn btn-success round btn-glow" id="tombolTambahUser"><i class="fa fa-user-plus"></i> Tambah Anggota</button>
  </div>
...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-content collapse show">
      <div class="card-body">
        <div class="container">
          <table class="table table-hover w-100 table-responsive" id="anggotaTable">
            <thead>
              <tr>
                <th><i class="fa fa-id-card"></i> ID</th>
                <th><i class="fa fa-image"></i> Foto Anggota</th>
                <th><i class="fa fa-user"></i> Nama Anggota</th>
                <th><i class="fa fa-id-card"></i> No Anggota </th>
                  ...
                  <td>
                    <div class="action-button btn-group text-center">
                      ...
                      <div class="dropdown-menu" x-placement="bottom-start">
                        <button class="dropdown-item tombolDetailAnggota" value="{{ $item->id }}">
  ...
  <div id="createUser" class="modal-create modal fade">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <form action="{{ route('users.anggota.store') }}" method="POST">
          ...
          <div class="modal-create-body modal-body">
            <div class="container">
              @csrf
                ...
                <div class="form-group">
                  <label class="label label-default"><i class="fa fa-id-card"></i> No Pegawai</label>
                  <input type="text" class="form-control" name="no_pegawai">
                </div>
                <div class="form-group">
                  <label class="label label-default"><i class="fa fa-id-card"></i> No Anggota</label>
                ...
                <div class="form-group">
                  ...
                  <input style="text-transform: capitalize;" type="text" class="form-control" value="anggota" name="hak_akses" required readonly>
                </div>
              <div class="form-group">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-detail-content modal-content">
        ...
        <div class="modal-detail-body modal-body">
          ...
          <p class="modal-detail-title">Data Anggota :</p><br><br>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="container modal-detail-data">
                  ...
                  <div class="row">
                    <div class="col-md-5 col-3 ">
                      <p> <i class="fa fa-id-card"></i> No Pegawai</p>
                    </div>
                    <div class="col-md-1 col-1">
                      <p>:</p>
                    </div>
                    <div class="col-md-5">
                      <p id="detail_no_pegawai"></p>
                    </div>
                  </div>

                  <div class="row">
                    <div class="col-md-5 col-3 ">
                      <p> <i class="fa fa-id-card"></i> No Anggota</p>
                    </div>
                    <div class="col-md-1 col-1">
                      <p>:</p>
                    </div>
  ...
  <div class="modal-delete modal fade" id="delete">
    <div class="modal-dialog modal-sm">
      <div class="modal-delete-content modal-content">
        <form action="{{ route('users.anggota.destroy') }}" method="POST">
          @csrf
          <!-- Modal Header -->
...
@section('script')
  ...
  <script type="text/javascript">
    ...
    $(".tombolDetailAnggota").on("click", function(){
      var id = $(this).val();
      $.ajax({
        method: "POST",
        url : "{{ route('users.anggota.detail') }}",
        data: {
          _token: token,
          id: id
        }
        ...
        $("#detail_no_pegawai").text(response.no_pegawai);
        $("#detail_no_anggota").text(response.no_anggota);
